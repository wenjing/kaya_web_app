...
curl -H "$http_head" -u admin@kaya-labs.com:password -X PUT -d "name=Diana Clarke&email=bessy.mee.1@kaya-labs.com&password=password&password_confirmation=password" ${url_root}/users/9
curl -H "$http_head" -u admin@kaya-labs.com:password -X PUT -d "name=Diana Clarke&email=bessy.mee.2@kaya-labs.com&password=password&password_confirmation=password" ${url_root}/users/10
curl -H "$http_head" -u admin@kaya-labs.com:password -X PUT -d "name=Diana Clarke&email=bessy.mee.3@kaya-labs.com&password=password&password_confirmation=password" ${url_root}/users/11
...
curl -H "$http_head" -u bessy.mee.2@kaya-labs.com:password -X GET ${url_root}/users/10/pending_meets
curl -H "$http_head" -u bessy.mee.3@kaya-labs.com:password -X GET ${url_root}/users/11/pending_meets
...
curl -H "$http_head" -u bessy.mee.2@kaya-labs.com:password -X GET ${url_root}/users/10/meets
curl -H "$http_head" -u bessy.mee.3@kaya-labs.com:password -X GET ${url_root}/users/11/meets
